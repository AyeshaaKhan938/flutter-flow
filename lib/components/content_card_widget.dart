...
export 'content_card_model.dart';

/// Reusable preview card for scripture, encouragement, and announcement
/// content.
...
class _ContentCardWidgetState extends State<ContentCardWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContentCardModel());
  }
