...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1A2A4A);
  late Color secondary = const Color(0xFFC4A35A);
  late Color tertiary = const Color(0xFF6B8F71);
  late Color alternate = const Color(0xFFE8E4DC);
  late Color primaryText = const Color(0xFF1A2A4A);
  late Color secondaryText = const Color(0xFF6A645C);
  late Color primaryBackground = const Color(0xFFF7F5F0);
  late Color secondaryBackground = const Color(0xFFFFFDF9);
  late Color accent1 = const Color(0x221A2A4A);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF2E7D5B);
  late Color warning = const Color(0xFFCB8A1E);
  late Color error = const Color(0xFFC0392B);
  late Color info = const Color(0xFF2C6E9E);
}
