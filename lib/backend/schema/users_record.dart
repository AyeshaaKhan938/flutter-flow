...
/// Member profiles (Auth UID as doc id)
class UsersRecord extends FirestoreRecord {
  ...
  void _initializeFields() {
    ...
    _preferredLanguage = snapshotData['preferredLanguage'] as String?;
    _createdAt = snapshotData['createdAt'] as DateTime?;
    _surveyResponses = snapshotData['surveyResponses'] as dynamic;
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    return e1?.role == e2?.role &&
        ...
        e1?.surveyResponses == e2?.surveyResponses &&
        e1?.email == e2?.email &&
